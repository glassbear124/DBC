...
//Api Url
#define API_URL    @"http://animal.tevreden.info/"//Development
...
#define my_color [UIColor colorWithRed:0/255.0 green:0xA9/255.0 blue:0xE4/255.0 alpha:1.0]
#define my_dark_color [UIColor colorWithRed:0/255.0 green:0x70/255.0 blue:0xAF/255.0 alpha:1.0]
...
#define baseUrl @"http://cupid.dierenbeschermingcuracao.com/"
#define fbAppId @"748916921954766";
int nCurLike;
int nCurLang;
